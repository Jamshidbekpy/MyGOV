    ...
    <form action='newss' method='post' >
        <div class='row align-items-center'>
            ...
            <div class='col mt-4'><label for='ish1'>Tug‘ilgan sanasi </label>
                <input type='text' id='ish1' class='form-control' placeholder='07.02.2022' name='t_sana'>
            </div>
            <div class='col mt-4'><label for='stir'> Ta'lim turi</label>
                <input type='text' id='stir' class='form-control' placeholder='Ta`lim turi' name='talim_turi'>
            </div>
            <div class='col mt-4'><label for='summa'>Ta`lim shakli </label>
                <input type='text' id='summa' class='form-control' placeholder='Ta`lim shakli' name='talim_shakli'>
            </div>
            <div class='col mt-4'><label for='ish'>Qabul turi</label>
                <input type='text' id='ish' class='form-control' placeholder='Qabul turi' name='qabul_turi'>
            </div>
            <div class='col mt-4'><label for='ish1'> O‘qishga kirgan yili </label>
                <input type='text' id='ish1' class='form-control' placeholder='2022' name='kirgan_yili'>
            </div>
            <div class='col mt-4'><label for='ish2'>Oliy ta`lim muassasasi </label>
                <input type='text' id='ish2' class='form-control' placeholder='Oliy ta`lim muassasasi' name='muassasa'>
            </div>
                <div class='col mt-4'><label for='ish2'>Fakultet</label>
                <input type='text' id='ish2' class='form-control' placeholder='Fakultet' name='fakultet'>
            </div>
                 <div class='col mt-4'> <label for='ish2'>Yo‘nalish </label>
                <input type='text' id='ish2' class='form-control' placeholder='Yo‘nalish' name='yonalish'>
            </div>
                 <div class='col mt-4'><label for='ish2'>O‘quv kursi</label>
                <input type='text' id='ish2' class='form-control' placeholder='O‘quv kursi' name='kurs'>
            </div>
